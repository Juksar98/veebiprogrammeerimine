	...
	if(isset($_POST["submit"])){
		...
		if(!empty($_FILES["fileToUpload"]["name"])){
			...
			//Kui saab üles laadida
				...
				$myPhoto->addWatermark("../../graphics/hmv_logo.png.png", $marginHor, $marginVer);
				...
				$notice = "Palun valige kõigepealt pildifail!";    //SEE KOHT ON VÄLJA KOMMENTEERITUD, SEST PROGRAMM EI TÖÖTA LAMBIST #eileiaviga
		}*/
...
<body>
	...
	<p><a href="usersideas.php">Ideed</a></p>
	<hr>
